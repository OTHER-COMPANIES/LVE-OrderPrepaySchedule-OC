CREATE OR REPLACE FUNCTION "ORDERDISCOUNT"(p_C_Order_ID number, p_PayDate date, p_LVE_OrderPrePaySchedule_ID number)
  RETURN number AS
/*************************************************************************
 ...
 * carlosaparadam@gmail.com Edited To Oracle Funcionality
 *************************************************************************
 ***
