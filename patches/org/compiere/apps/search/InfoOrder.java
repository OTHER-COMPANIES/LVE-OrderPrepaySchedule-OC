...
//	private VLookup fOrg_ID;
	...
	//	Add OpenAmt and LVE_OrderPrePaySchedule_ID
	...
	private static final Info_Column[] s_invoiceLayout = {
		...
		new Info_Column(Msg.translate(Env.getCtx(), "OpenAmt"), "orderOpen(o.C_Order_ID, o.LVE_OrderPrePaySchedule_ID)",  BigDecimal.class),
		...
		new Info_Column("", "''", KeyNamePair.class, "o.LVE_OrderPrePaySchedule_ID")
	};
