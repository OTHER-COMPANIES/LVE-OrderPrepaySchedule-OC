...
/** Generated Model for LVE_OrderPrePaySchedule
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS - $Id$ */
public class X_LVE_OrderPrePaySchedule extends PO implements I_LVE_OrderPrePaySchedule, I_Persistent 
{
    ...
    public X_LVE_OrderPrePaySchedule (Properties ctx, int LVE_OrderPrePaySchedule_ID, String trxName)
    {
      ...
      /** if (LVE_OrderPrePaySchedule_ID == 0)
        {
			...
			setIsValid (false);
			setLVE_OrderPrePaySchedule_ID (0);
			setProcessed (false);
        } */
    }

    /** Load Constructor */
    public X_LVE_OrderPrePaySchedule (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_LVE_OrderPrePaySchedule[")
	...
	/** Set Order Pre-Payment Schedule.
		@param LVE_OrderPrePaySchedule_ID Order Pre-Payment Schedule	  */
	public void setLVE_OrderPrePaySchedule_ID (int LVE_OrderPrePaySchedule_ID)
	{
		if (LVE_OrderPrePaySchedule_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_LVE_OrderPrePaySchedule_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_LVE_OrderPrePaySchedule_ID, Integer.valueOf(LVE_OrderPrePaySchedule_ID));
	}

	/** Get Order Pre-Payment Schedule.
		@return Order Pre-Payment Schedule	  */
	public int getLVE_OrderPrePaySchedule_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_LVE_OrderPrePaySchedule_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
